...
##### Weight is given by the product of the recruitment curve and the diameter probability curve
    phiWeight[0][0] =  MaffProb(d,maffProb,distribution_params[0])  * recruitment[0] * numFibersPerFascicle
    phiWeight[0][1] =  MeffProb(d,meffProb,distribution_params[1])  * recruitment[0] * numFibersPerFascicle
