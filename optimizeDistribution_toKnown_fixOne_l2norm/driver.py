...
def main():
    ...
    distribution_params = {'maff':{'diameterParams':analytic_input, 'fiberTypeFractions':None},'meff':{'diameterParams':np.ones_like(analytic_input)*[9.28,0.36], 'fiberTypeFractions':None}}
